            ...
            <div>
              ...
              <div style={{ marginTop: 36 }}>
                {submitted ? (
                  ...
                  <div style={{ display: 'flex', gap: 8, padding: 6, background: 'rgba(255,255,255,0.10)', border: '1px solid rgba(255,255,255,0.18)', borderRadius: 16, maxWidth: 460 }}>
                    <input
                      type="email"
                      value={email}
                    ...
                    />
                    <WBtn variant="light" size="md" onClick={() => email.includes('@') && setSubmitted(true)}>
                      Notify me ⚡
                    </WBtn>
                  </div>
                )}
