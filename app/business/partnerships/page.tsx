...
export default function PartnershipsPage(){return <main className="marketing-page"><Nav dark/>
  <section className="partnership-hero"><Container><div className="partnership-hero-grid"><div><span className="eyebrow light">TELECOM & TECHNOLOGY PARTNERSHIPS</span><h1>Let&apos;s build the connection layer together.</h1><p className="hero-lead">Behind every call, message and moment of connection are people — and the partners who make it possible. Wiftco has built the digital application and provider-independent control layer. Now we&apos;re looking for the right people to bring carrier-integrated services to market with us.</p><div className="button-row"><a className="button light-button" href="mailto:partnerships@wiftco.com">Start a conversation</a><a className="button secondary" style={{color:'#fff',background:'transparent',borderColor:'rgba(255,255,255,.35)'}} href="mailto:partnerships@wiftco.com?subject=Wiftco%20technical%20capabilities">View technical capabilities</a></div></div><figure className="people-hero partnership-people"><img src="/people/partnership-team.png" alt="Nigerian telecom and technology leaders discussing a partnership"/><figcaption>Serious technology. Real collaboration.</figcaption></figure></div></Container></section>
