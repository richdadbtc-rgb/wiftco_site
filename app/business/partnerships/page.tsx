...
export default function PartnershipsPage(){return <main className="marketing-page"><Nav dark/>
  <section className="partnership-hero"><Container><div style={{maxWidth:780}}><span className="eyebrow light">TELECOM & TECHNOLOGY PARTNERSHIPS</span><h1>Let&apos;s build the connection layer together.</h1><p className="hero-lead">Wiftco has built the digital application and provider-independent telecom control layer. We are now engaging authorised network and infrastructure partners to bring carrier-integrated services to market.</p><div className="button-row"><a className="button light-button" href="mailto:partnerships@wiftco.com">Discuss a partnership</a><a className="button secondary" style={{color:'#fff',background:'transparent',borderColor:'rgba(255,255,255,.35)'}} href="mailto:partnerships@wiftco.com?subject=Wiftco%20technical%20capabilities">View technical capabilities</a></div></div></Container></section>
