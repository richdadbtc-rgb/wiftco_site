      ...
      <div style={{ padding: '60px 0', background: '#fff' }}>
        <Container>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16 }}>
            {CATEGORIES.map((c, i) => (
              <div key={i} style={{ padding: 24, background: '#FAFAFB', borderRadius: 16, border: `1px solid ${SC.hairline}`, display: 'flex', gap: 16, alignItems: 'center', cursor: 'pointer' }}>
                ...
                <div style={{ color: SC.faint }}><IcoChevR size={18} /></div>
              </div>
            ))}
          </div>
        </Container>
